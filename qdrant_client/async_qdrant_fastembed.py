...
class AsyncQdrantFastembedMixin(AsyncQdrantBase):
    ...
    @classmethod
    def _get_or_init_model(cls, model_name: str, cache_dir: Optional[str] = None) -> "DefaultEmbedding":
        ...
        cls.embedding_models[model_name] = DefaultEmbedding(model_name=model_name, cache_dir=cache_dir)
        return cls.embedding_models[model_name]
    ...
    def _embed_documents(
        ...
        embedding_model = self._get_or_init_model(model_name=embedding_model_name, cache_dir=embedding_model_cache_dir)
